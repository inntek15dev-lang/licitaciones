...
6.  **Tier 9**: **Late Binding Constraints**. Resolves circular references between `users` and `mandantes`/`contratistas`.
...
- **Knowledge Codification**: The `.gemini/skills/laravel-data-architect/SKILL.md` has been updated to include these best practices, ensuring all future refactors follow this robust pattern.
...
# Output: ¡Base de datos sembrada con datos iniciales y tipos de documento!
```
