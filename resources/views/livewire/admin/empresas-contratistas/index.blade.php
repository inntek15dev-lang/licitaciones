<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Empresas Contratistas</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Gestiona los proveedores registrados en la plataforma</p>
            </div>
            <button wire:click="openModal" class="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white font-medium rounded-xl transition-colors shadow-lg shadow-sky-500/25">
        ...
        <div class="mb-6">
            <div class="relative">
                ...
                <input 
                    ...
                    class="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:text-white"
                >
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ $empresa->sitio_web ?: 'Sin sitio web' }}</div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 dark:text-white">{{ $empresa->persona_contacto ?: '-' }}</div>
                                <div class="text-xs text-gray-500 dark:text-gray-400">{{ $empresa->email_contacto ?: '-' }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button wire:click="edit({{ $empresa->id }})" class="p-2 text-gray-400 hover:text-sky-600 dark:hover:text-sky-400 transition-colors" title="Editar">
                                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No hay contratistas</h3>
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Comienza agregando la primera empresa contratista</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
                ...
                <form wire:submit="save">
                    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            {{ $editMode ? 'Editar Empresa' : 'Nueva Empresa Contratista' }}
                        </h3>
                    </div>
                    ...
                    <div class="px-6 py-6 space-y-4 max-h-96 overflow-y-auto">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2">
                                ...
                                <input wire:model="razon_social" type="text" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="Nombre de la empresa">
                            ...
                            <div>
                                ...
                                <input wire:model="rut" type="text" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="12.345.678-9">
                                @error('rut')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Teléfono</label>
                                <input wire:model="telefono" type="text" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="+56 9 1234 5678">
                                @error('telefono')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Dirección</label>
                                <input wire:model="direccion" type="text" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="Av. Principal 123, Santiago">
                            ...
                            <div>
                                ...
                                <input wire:model="persona_contacto" type="text" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="Juan Pérez">
                                @error('persona_contacto')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email de Contacto</label>
                                <input wire:model="email_contacto" type="email" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="contacto@empresa.cl">
                                @error('email_contacto')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sitio Web</label>
                                <input wire:model="sitio_web" type="url" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:text-white" placeholder="https://www.empresa.cl">
                                @error('sitio_web')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div class="sm:col-span-2">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input wire:model="activo" type="checkbox" class="w-4 h-4 text-sky-600 border-gray-300 rounded focus:ring-sky-500">
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-sky-600 hover:bg-sky-700 rounded-xl shadow-lg shadow-sky-500/25">
